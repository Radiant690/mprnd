...
<a href="#" className="text-gray-400 hover:text-indigo-600 transition duration-150 ease-in-out">
...
<FaGithub className="h-6 w-6" />
...
</div>      <form onSubmit={handleSubmit(onSubmit)} className="mt-16 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
        <div>
          <label htmlFor="name" className="block text-base font-medium leading-5 text-gray-700">Full name</label>
          <div className="mt-1 rounded-md shadow-sm">
            <input id="name" name="name" type="text" {...register('name', { required: true })} className="form-input py-3 px-4 block w-full transition ease-in-out duration-150" />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-1 rounded-md shadow-sm">
            <input id="email" name="email" type="email" {...register('email', { required: true })} className="form-input py-3 px-4 block w-full transition ease-in-out duration-150" />
          </div>
        </div>
        ...
        <div className="sm:col-span-2">
          ...
          <div className="mt-1 rounded-md shadow-sm">
            <input id="subject" name="subject" type="text" {...register('subject', { required: true })} className="form-input py-3 px-4 block w-full transition ease-in-out duration-150" />
          </div>
        </div>
        ...
        <div className="sm:col-span-2">
          ...
          <div className="mt-1 rounded-md shadow-sm">
            <textarea id="message" name="message" rows="4" {...register('message', { required: true })} className="form-textarea py-3 px-4 block w-full transition ease-in-out duration-150"></textarea>
          </div>
        </div>

        <div className="sm:col-span-2">
          <span className="inline-flex rounded-md shadow-sm">
            <button type="submit" disabled={isSending} className={`${isSending ? 'opacity-50 cursor-not-allowed' : ''} inline-flex justify-center py-3 px-6 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700 transition ease-in-out duration-150`}>
